# here, the game is, you need to guess the number between 1 to 100. the number between 1 to 100 is autometically generated but you dont't know that number and you have to guess which number is that. 
